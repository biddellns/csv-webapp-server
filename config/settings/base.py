"""
Django settings for csv_web_app_server project.
...
BASE_DIR = os.path.dirname(path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'csv_web_app_server.file_upload'
]
